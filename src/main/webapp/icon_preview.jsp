...
<div class="site-section">
    <div class="pt-5">
        <div class="container">
            <div class="row justify-content-center">
                <h5 class="mt-5 d-block w-100">dripicons</h5>
    ...
    <div class="mt-2">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-bottom-right-thin-circle-outline"></i><span>mdi-arrow-bottom-right-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-down-thin-circle-outline"></i><span>mdi-arrow-down-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-left-thin-circle-outline"></i><span>mdi-arrow-left-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-right-thin-circle-outline"></i><span>mdi-arrow-right-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-top-left-thin-circle-outline"></i><span>mdi-arrow-top-left-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-top-right-thin-circle-outline"></i><span>mdi-arrow-top-right-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-arrow-up-thin-circle-outline"></i><span>mdi-arrow-up-thin-circle-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-bag-suitcase"></i><span>mdi-bag-suitcase</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-bag-suitcase-off"></i><span>mdi-bag-suitcase-off</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-bag-suitcase-off-outline"></i><span>mdi-bag-suitcase-off-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-bag-suitcase-outline"></i><span>mdi-bag-suitcase-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-butterfly"></i><span>mdi-butterfly</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-butterfly-outline"></i><span>mdi-butterfly-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-calculator-variant-outline"></i><span>mdi-calculator-variant-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-calendar-cursor"></i><span>mdi-calendar-cursor</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-comment-bookmark"></i><span>mdi-comment-bookmark</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-comment-bookmark-outline"></i><span>mdi-comment-bookmark-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-comment-flash"></i><span>mdi-comment-flash</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-comment-flash-outline"></i><span>mdi-comment-flash-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-dance-pole"></i><span>mdi-dance-pole</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-delete-clock"></i><span>mdi-delete-clock</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-delete-clock-outline"></i><span>mdi-delete-clock-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-eiffel-tower"></i><span>mdi-eiffel-tower</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-emoticon-sick"></i><span>mdi-emoticon-sick</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-emoticon-sick-outline"></i><span>mdi-emoticon-sick-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-face-mask"></i><span>mdi-face-mask</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-face-mask-outline"></i><span>mdi-face-mask-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-food-halal"></i><span>mdi-food-halal</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-food-kosher"></i><span>mdi-food-kosher</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-hand-heart-outline"></i><span>mdi-hand-heart-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-hand-wash"></i><span>mdi-hand-wash</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-hand-wash-outline"></i><span>mdi-hand-wash-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-handshake-outline"></i><span>mdi-handshake-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-human-cane"></i><span>mdi-human-cane</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-human-capacity-decrease"></i><span>mdi-human-capacity-decrease</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-human-capacity-increase"></i><span>mdi-human-capacity-increase</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-human-greeting-proximity"></i><span>mdi-human-greeting-proximity</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-human-queue"></i><span>mdi-human-queue</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-hvac-off"></i><span>mdi-hvac-off</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-inbox-remove"></i><span>mdi-inbox-remove</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-inbox-remove-outline"></i><span>mdi-inbox-remove-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-kangaroo"></i><span>mdi-kangaroo</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-key-chain"></i><span>mdi-key-chain</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-key-chain-variant"></i><span>mdi-key-chain-variant</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-ladder"></i><span>mdi-ladder</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-lamps"></i><span>mdi-lamps</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-list-status"></i><span>mdi-list-status</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-lotion"></i><span>mdi-lotion</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-lotion-outline"></i><span>mdi-lotion-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-lotion-plus"></i><span>mdi-lotion-plus</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-lotion-plus-outline"></i><span>mdi-lotion-plus-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-message-bookmark"></i><span>mdi-message-bookmark</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-message-bookmark-outline"></i><span>mdi-message-bookmark-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-message-flash"></i><span>mdi-message-flash</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-message-flash-outline"></i><span>mdi-message-flash-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion"></i><span>mdi-motion</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion-outline"></i><span>mdi-motion-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion-pause"></i><span>mdi-motion-pause</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion-pause-outline"></i><span>mdi-motion-pause-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion-play"></i><span>mdi-motion-play</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-motion-play-outline"></i><span>mdi-motion-play-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-mouse-move-down"></i><span>mdi-mouse-move-down</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-mouse-move-up"></i><span>mdi-mouse-move-up</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-mouse-move-vertical"></i><span>mdi-mouse-move-vertical</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-phone-dial"></i><span>mdi-phone-dial</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-phone-dial-outline"></i><span>mdi-phone-dial-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-pitchfork"></i><span>mdi-pitchfork</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-pretzel"></i><span>mdi-pretzel</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-reiterate"></i><span>mdi-reiterate</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-router-wireless-off"></i><span>mdi-router-wireless-off</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-seesaw"></i><span>mdi-seesaw</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-shield-account-variant"></i><span>mdi-shield-account-variant</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-shield-account-variant-outline"></i><span>mdi-shield-account-variant-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-slide"></i><span>mdi-slide</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-social-distance-2-meters"></i><span>mdi-social-distance-2-meters</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-social-distance-6-feet"></i><span>mdi-social-distance-6-feet</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-sofa-outline"></i><span>mdi-sofa-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-sofa-single"></i><span>mdi-sofa-single</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-sofa-single-outline"></i><span>mdi-sofa-single-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-check"></i><span>mdi-star-check</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-check-outline"></i><span>mdi-star-check-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-minus"></i><span>mdi-star-minus</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-minus-outline"></i><span>mdi-star-minus-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-off-outline"></i><span>mdi-star-off-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-plus"></i><span>mdi-star-plus</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-plus-outline"></i><span>mdi-star-plus-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-remove"></i><span>mdi-star-remove</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-star-remove-outline"></i><span>mdi-star-remove-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-submarine"></i><span>mdi-submarine</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-text-account"></i><span>mdi-text-account</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-check"></i><span>mdi-tooltip-check</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-check-outline"></i><span>mdi-tooltip-check-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-minus"></i><span>mdi-tooltip-minus</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-minus-outline"></i><span>mdi-tooltip-minus-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-remove"></i><span>mdi-tooltip-remove</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-tooltip-remove-outline"></i><span>mdi-tooltip-remove-outline</span></div>
                <div class="col-xl-3 col-lg-4 col-sm-6"><i class="mdi mdi-vanish-quarter"></i><span>mdi-vanish-quarter</span></div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-2">
        <div class="container">
            <div class="row justify-content-center">
                <h5 class="mt-5 d-block w-100">Fontawesome</h5>
    ...
    <div class="mt-2">
        <div class="container">
            <div class="row justify-content-center">
                <h5 class="mt-5 d-block w-100">unicons</h5>
                <div class="col-sm-6 col-md-4 col-lg-3">
